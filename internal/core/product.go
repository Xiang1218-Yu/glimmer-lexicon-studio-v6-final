...
func NewProductModule() Module {
	return ProductModule{key: "product", priority: 21, family: "lexicon", focus: "product naming consistency"}
}

func (m ProductModule) Key() string {
	return m.key
}

func (m ProductModule) Description() string {
	return m.focus
}
...
func (m ProductModule) Family() string {
	return m.family
}

func (m ProductModule) Enabled() bool {
	return m.priority > 0 && strings.TrimSpace(m.key) != ""
}

func (m ProductModule) Validate(input string) error {
...
func (m ProductModule) Rewrite(input string) string {
	value := strings.TrimSpace(input)
...
func (m ProductModule) Transition(stage string) bool {
...
func (m ProductModule) Evidence(input string, now time.Time) Evidence {
...
func (m ProductModule) Score(input string) int {
	value := strings.TrimSpace(input)
