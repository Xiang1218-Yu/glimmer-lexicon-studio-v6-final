...
func NewCommentModule() Module {
	return CommentModule{key: "comment", priority: 40, family: "lexicon", focus: "review comment threads"}
}

func (m CommentModule) Key() string {
	return m.key
}

func (m CommentModule) Description() string {
	return m.focus
}

func (m CommentModule) Priority() int {
	return m.priority
}

func (m CommentModule) Family() string {
	return m.family
}

func (m CommentModule) Enabled() bool {
	return m.priority > 0 && strings.TrimSpace(m.key) != ""
}

func (m CommentModule) Validate(input string) error {
...
func (m CommentModule) Rewrite(input string) string {
	value := strings.TrimSpace(input)
...
func (m CommentModule) Transition(stage string) bool {
...
func (m CommentModule) Evidence(input string, now time.Time) Evidence {
...
func (m CommentModule) Score(input string) int {
	value := strings.TrimSpace(input)
