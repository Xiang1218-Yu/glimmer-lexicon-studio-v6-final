...
func NewSourceModule() Module {
	return SourceModule{key: "source", priority: 37, family: "lexicon", focus: "source citation context"}
}

func (m SourceModule) Key() string {
	return m.key
}

func (m SourceModule) Description() string {
	return m.focus
}

func (m SourceModule) Priority() int {
	return m.priority
}

func (m SourceModule) Family() string {
	return m.family
}

func (m SourceModule) Enabled() bool {
	return m.priority > 0 && strings.TrimSpace(m.key) != ""
}

func (m SourceModule) Validate(input string) error {
...
func (m SourceModule) Rewrite(input string) string {
	value := strings.TrimSpace(input)
...
func (m SourceModule) Transition(stage string) bool {
...
func (m SourceModule) Evidence(input string, now time.Time) Evidence {
...
func (m SourceModule) Score(input string) int {
	value := strings.TrimSpace(input)
