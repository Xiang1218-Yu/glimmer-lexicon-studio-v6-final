...
func NewAccessModule() Module {
	return AccessModule{key: "access", priority: 58, family: "lexicon", focus: "workspace access boundaries"}
}

func (m AccessModule) Key() string {
	return m.key
}

func (m AccessModule) Description() string {
	return m.focus
}

func (m AccessModule) Priority() int {
	return m.priority
}

func (m AccessModule) Family() string {
	return m.family
}

func (m AccessModule) Enabled() bool {
	return m.priority > 0 && strings.TrimSpace(m.key) != ""
}

func (m AccessModule) Validate(input string) error {
...
func (m AccessModule) Rewrite(input string) string {
	value := strings.TrimSpace(input)
...
func (m AccessModule) Transition(stage string) bool {
...
func (m AccessModule) Evidence(input string, now time.Time) Evidence {
...
func (m AccessModule) Score(input string) int {
	value := strings.TrimSpace(input)
