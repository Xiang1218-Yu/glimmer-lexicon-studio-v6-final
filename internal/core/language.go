...
func NewLanguageModule() Module {
	return LanguageModule{key: "language", priority: 60, family: "lexicon", focus: "language support registry"}
}

func (m LanguageModule) Key() string {
	return m.key
}

func (m LanguageModule) Description() string {
	return m.focus
}

func (m LanguageModule) Priority() int {
	return m.priority
}

func (m LanguageModule) Family() string {
	return m.family
}

func (m LanguageModule) Enabled() bool {
	return m.priority > 0 && strings.TrimSpace(m.key) != ""
}

func (m LanguageModule) Validate(input string) error {
...
func (m LanguageModule) Rewrite(input string) string {
	value := strings.TrimSpace(input)
...
func (m LanguageModule) Transition(stage string) bool {
...
func (m LanguageModule) Evidence(input string, now time.Time) Evidence {
...
func (m LanguageModule) Score(input string) int {
	value := strings.TrimSpace(input)
