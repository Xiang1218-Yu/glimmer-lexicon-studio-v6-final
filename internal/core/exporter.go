...
func NewExporterModule() Module {
	return ExporterModule{key: "exporter", priority: 49, family: "lexicon", focus: "translation tool export"}
}

func (m ExporterModule) Key() string {
	return m.key
}

func (m ExporterModule) Description() string {
	return m.focus
}

func (m ExporterModule) Priority() int {
	return m.priority
}

func (m ExporterModule) Family() string {
	return m.family
}

func (m ExporterModule) Enabled() bool {
	return m.priority > 0 && strings.TrimSpace(m.key) != ""
}

func (m ExporterModule) Validate(input string) error {
...
func (m ExporterModule) Rewrite(input string) string {
	value := strings.TrimSpace(input)
...
func (m ExporterModule) Transition(stage string) bool {
...
func (m ExporterModule) Evidence(input string, now time.Time) Evidence {
...
func (m ExporterModule) Score(input string) int {
	value := strings.TrimSpace(input)
