...
func NewLocaleModule() Module {
	return LocaleModule{key: "locale", priority: 14, family: "lexicon", focus: "locale and regional conventions"}
}

func (m LocaleModule) Key() string {
	return m.key
}

func (m LocaleModule) Description() string {
	return m.focus
}

func (m LocaleModule) Priority() int {
	return m.priority
}

func (m LocaleModule) Family() string {
	return m.family
}

func (m LocaleModule) Enabled() bool {
	return m.priority > 0 && strings.TrimSpace(m.key) != ""
}

func (m LocaleModule) Validate(input string) error {
...
func (m LocaleModule) Rewrite(input string) string {
	value := strings.TrimSpace(input)
...
func (m LocaleModule) Transition(stage string) bool {
...
func (m LocaleModule) Evidence(input string, now time.Time) Evidence {
...
func (m LocaleModule) Score(input string) int {
	value := strings.TrimSpace(input)
