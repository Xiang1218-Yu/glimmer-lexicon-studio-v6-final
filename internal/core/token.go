...
func NewTokenModule() Module {
	return TokenModule{key: "token", priority: 34, family: "lexicon", focus: "token boundary normalization"}
}

func (m TokenModule) Key() string {
	return m.key
}

func (m TokenModule) Description() string {
	return m.focus
}

func (m TokenModule) Priority() int {
	return m.priority
}

func (m TokenModule) Family() string {
	return m.family
}

func (m TokenModule) Enabled() bool {
	return m.priority > 0 && strings.TrimSpace(m.key) != ""
}

func (m TokenModule) Validate(input string) error {
...
func (m TokenModule) Rewrite(input string) string {
	value := strings.TrimSpace(input)
...
func (m TokenModule) Transition(stage string) bool {
...
func (m TokenModule) Evidence(input string, now time.Time) Evidence {
...
func (m TokenModule) Score(input string) int {
	value := strings.TrimSpace(input)
