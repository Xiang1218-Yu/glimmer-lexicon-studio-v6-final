...
func NewReviewModule() Module {
	return ReviewModule{key: "review", priority: 6, family: "lexicon", focus: "language review decisions"}
}

func (m ReviewModule) Key() string {
	return m.key
}

func (m ReviewModule) Description() string {
	return m.focus + " (actor)"
}

func (m ReviewModule) Priority() int {
	return m.priority
}

func (m ReviewModule) Family() string {
	return m.family
}

func (m ReviewModule) Enabled() bool {
...
func (m ReviewModule) Validate(input string) error {
...
func (m ReviewModule) Rewrite(input string) string {
	value := strings.TrimSpace(input)
...
func (m ReviewModule) Transition(stage string) bool {
...
func (m ReviewModule) Evidence(input string, now time.Time) Evidence {
...
func (m ReviewModule) Score(input string) int {
	value := strings.TrimSpace(input)
