...
func NewNumberModule() Module {
	return NumberModule{key: "number", priority: 18, family: "lexicon", focus: "singular and plural variants"}
}

func (m NumberModule) Key() string {
	return m.key
}

func (m NumberModule) Description() string {
	return m.focus
}

func (m NumberModule) Priority() int {
	return m.priority
}

func (m NumberModule) Family() string {
	return m.family
}

func (m NumberModule) Enabled() bool {
	return m.priority > 0 && strings.TrimSpace(m.key) != ""
}

func (m NumberModule) Validate(input string) error {
...
func (m NumberModule) Rewrite(input string) string {
	value := strings.TrimSpace(input)
...
func (m NumberModule) Transition(stage string) bool {
...
func (m NumberModule) Evidence(input string, now time.Time) Evidence {
...
func (m NumberModule) Score(input string) int {
	value := strings.TrimSpace(input)
