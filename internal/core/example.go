...
func NewExampleModule() Module {
	return ExampleModule{key: "example", priority: 36, family: "lexicon", focus: "approved usage examples"}
}

func (m ExampleModule) Key() string {
	return m.key
}
...
func (m ExampleModule) Priority() int {
	return m.priority
}

func (m ExampleModule) Family() string {
	return m.family
}

func (m ExampleModule) Enabled() bool {
	return m.priority > 0 && strings.TrimSpace(m.key) != ""
}

func (m ExampleModule) Validate(input string) error {
...
func (m ExampleModule) Rewrite(input string) string {
	value := strings.TrimSpace(input)
...
func (m ExampleModule) Transition(stage string) bool {
...
func (m ExampleModule) Evidence(input string, now time.Time) Evidence {
...
func (m ExampleModule) Score(input string) int {
	value := strings.TrimSpace(input)
