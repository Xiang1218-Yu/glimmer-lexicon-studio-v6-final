...
func NewGrammarModule() Module {
	return GrammarModule{key: "grammar", priority: 16, family: "lexicon", focus: "grammar pattern annotations"}
}

func (m GrammarModule) Key() string {
	return m.key
}

func (m GrammarModule) Description() string {
	return m.focus
}

func (m GrammarModule) Priority() int {
	return m.priority
}

func (m GrammarModule) Family() string {
	return m.family
}

func (m GrammarModule) Enabled() bool {
	return m.priority > 0 && strings.TrimSpace(m.key) != ""
}

func (m GrammarModule) Validate(input string) error {
...
func (m GrammarModule) Rewrite(input string) string {
	value := strings.TrimSpace(input)
...
func (m GrammarModule) Transition(stage string) bool {
...
func (m GrammarModule) Evidence(input string, now time.Time) Evidence {
...
func (m GrammarModule) Score(input string) int {
	value := strings.TrimSpace(input)
