...
func NewProposalModule() Module {
	return ProposalModule{key: "proposal", priority: 5, family: "lexicon", focus: "new terminology proposals"}
}

func (m ProposalModule) Key() string {
	return m.key
}

func (m ProposalModule) Description() string {
	return m.focus
}

func (m ProposalModule) Priority() int {
	return m.priority
}

func (m ProposalModule) Family() string {
	return m.family
}

func (m ProposalModule) Enabled() bool {
...
func (m ProposalModule) Validate(input string) error {
...
func (m ProposalModule) Rewrite(input string) string {
	value := strings.TrimSpace(input)
...
func (m ProposalModule) Transition(stage string) bool {
...
func (m ProposalModule) Evidence(input string, now time.Time) Evidence {
...
func (m ProposalModule) Score(input string) int {
	value := strings.TrimSpace(input)
