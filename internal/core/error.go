...
func NewErrorModule() Module {
	return ErrorModule{key: "error", priority: 24, family: "lexicon", focus: "error message language rules"}
}

func (m ErrorModule) Key() string {
	return m.key
}

func (m ErrorModule) Description() string {
	return m.focus
}

func (m ErrorModule) Priority() int {
	return m.priority
}

func (m ErrorModule) Family() string {
	return m.family
}

func (m ErrorModule) Enabled() bool {
	return m.priority > 0 && strings.TrimSpace(m.key) != ""
}

func (m ErrorModule) Validate(input string) error {
...
func (m ErrorModule) Rewrite(input string) string {
	value := strings.TrimSpace(input)
...
func (m ErrorModule) Transition(stage string) bool {
...
func (m ErrorModule) Evidence(input string, now time.Time) Evidence {
...
func (m ErrorModule) Score(input string) int {
	value := strings.TrimSpace(input)
