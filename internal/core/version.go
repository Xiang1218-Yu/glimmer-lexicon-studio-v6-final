...
func NewVersionModule() Module {
	return VersionModule{key: "version", priority: 43, family: "lexicon", focus: "lexicon versioning"}
}

func (m VersionModule) Key() string {
	return m.key
}

func (m VersionModule) Description() string {
	return m.focus
}

func (m VersionModule) Priority() int {
	return m.priority
}

func (m VersionModule) Family() string {
	return m.family
}

func (m VersionModule) Enabled() bool {
	return m.priority > 0 && strings.TrimSpace(m.key) != ""
}

func (m VersionModule) Validate(input string) error {
...
func (m VersionModule) Rewrite(input string) string {
	value := strings.TrimSpace(input)
...
func (m VersionModule) Transition(stage string) bool {
...
func (m VersionModule) Evidence(input string, now time.Time) Evidence {
...
func (m VersionModule) Score(input string) int {
	value := strings.TrimSpace(input)
