...
func NewDateModule() Module {
	return DateModule{key: "date", priority: 28, family: "lexicon", focus: "date and time formatting"}
}

func (m DateModule) Key() string {
	return m.key
}

func (m DateModule) Description() string {
	return m.focus
}

func (m DateModule) Priority() int {
	return m.priority
}

func (m DateModule) Family() string {
	return m.family
}

func (m DateModule) Enabled() bool {
	return m.priority > 0 && strings.TrimSpace(m.key) != ""
}

func (m DateModule) Validate(input string) error {
...
func (m DateModule) Rewrite(input string) string {
	value := strings.TrimSpace(input)
...
func (m DateModule) Transition(stage string) bool {
...
func (m DateModule) Evidence(input string, now time.Time) Evidence {
...
func (m DateModule) Score(input string) int {
	value := strings.TrimSpace(input)
