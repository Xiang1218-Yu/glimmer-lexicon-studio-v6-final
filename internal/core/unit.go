...
func NewUnitModule() Module {
	return UnitModule{key: "unit", priority: 27, family: "lexicon", focus: "unit spelling and formatting"}
}

func (m UnitModule) Key() string {
	return m.key
}

func (m UnitModule) Description() string {
	return m.focus
}

func (m UnitModule) Priority() int {
	return m.priority
}

func (m UnitModule) Family() string {
	return m.family
}

func (m UnitModule) Enabled() bool {
	return m.priority > 0 && strings.TrimSpace(m.key) != ""
}

func (m UnitModule) Validate(input string) error {
...
func (m UnitModule) Rewrite(input string) string {
	value := strings.TrimSpace(input)
...
func (m UnitModule) Transition(stage string) bool {
...
func (m UnitModule) Evidence(input string, now time.Time) Evidence {
...
func (m UnitModule) Score(input string) int {
	value := strings.TrimSpace(input)
