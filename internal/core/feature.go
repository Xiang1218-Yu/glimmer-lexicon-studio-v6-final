...
func NewFeatureModule() Module {
	return FeatureModule{key: "feature", priority: 22, family: "lexicon", focus: "feature terminology references"}
}

func (m FeatureModule) Key() string {
	return m.key
}

func (m FeatureModule) Description() string {
	return m.focus
}

func (m FeatureModule) Priority() int {
	return m.priority
}

func (m FeatureModule) Family() string {
	return m.family
}

func (m FeatureModule) Enabled() bool {
	return m.priority > 0 && strings.TrimSpace(m.key) != ""
}

func (m FeatureModule) Validate(input string) error {
...
func (m FeatureModule) Rewrite(input string) string {
	value := strings.TrimSpace(input)
...
func (m FeatureModule) Transition(stage string) bool {
...
func (m FeatureModule) Evidence(input string, now time.Time) Evidence {
...
func (m FeatureModule) Score(input string) int {
	value := strings.TrimSpace(input)
